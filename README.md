...
**Состояние на 21 апреля 2026 года:**
...
4. **v2rayNG** ✅ - вижу **"Пользователь/пароль локального прокси" в настройках** версии для Android. На **ПК-версии** (**v2rayN**❌) проблема не решена.

5. **Happ** ✅ - **убран HandlerService на Android, при этом и на Android, и на iOS сделана "Авторизация inbound".**  На **ПК-версии** ❌ проблема не решена.

6. **v2raytun** - на **Android** ✅ добавлен логин/пароль локального socks5 прокси, для **iOS** ❌ ничего сделано не было.
